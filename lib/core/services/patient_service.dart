...
final _mockProfile = PatientProfile(
  ...
  profileImageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=60',
  address: 'Maddi, Cairo',
  bloodType: 'B+',
  allergies: 'None',
...
final _mockFavorites = <DoctorListItem>[
  DoctorListItem(
    ...
    profileImageUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=600&auto=format&fit=crop&q=60',
    consultationFee: 300,
    averageRating: 4.6,
    totalReviews: 210,
    isAvailable: true,
