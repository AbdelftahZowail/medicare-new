        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkMap = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelegramMappings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubSpecialty = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    GraduationYear = table.Column<int>(type: "int", nullable: true),
                    BoardCertification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChronicDiseases = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    InternalNotes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QueueStatus = table.Column<int>(type: "int", nullable: true),
                    RefundStatus = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CancellationReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OfflinePatientName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    OfflinePatientPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IsEmergency = table.Column<bool>(type: "bit", nullable: false),
                    ChiefComplaint = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false),
                    OfflinePatientAge = table.Column<int>(type: "int", nullable: true),
                    OfflinePatientGender = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinics_Area",
                table: "Clinics",
                column: "Area");

            migrationBuilder.CreateIndex(
                name: "IX_Clinics_Government",
                table: "Clinics",
                column: "Government");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientFavorites_PatientId_DoctorId",
                table: "PatientFavorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelegramMappings_PhoneNumber",
                table: "TelegramMappings",
                column: "PhoneNumber",
                unique: true);
